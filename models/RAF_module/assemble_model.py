...
for i in range(4):
    ...
    if i == 3:
        enumerate_rules(model, model.rules['BRAF_BRAF_bind'],
                        ['map2k1', 'V600'])
        enumerate_rules(model, model.rules['BRAF_BRAF_dissociate'],
                        ['map2k1', 'V600'])
        enumerate_rules(model, model.rules['VEMURAFENIB_BRAF_bind'],
                        ['map2k1', 'nras', 'V600'])
        enumerate_rules(model, model.rules['VEMURAFENIB_BRAF_dissociate'],
                        ['map2k1', 'nras', 'V600'])
